...
export const Scheduling_Card_Gr10 = () => {
    ...
    return (
        <>
            ...
            <ReusableModalBox show={showEditModal} onClose={() => setShowEditModal(false)}>
                <div className="scheduduleEdit">
                    <div className="faculty_card_header_grade10"></div>
                    <div className="scheduleEditBody">
                        <h3>Name: Karen M. Corpus</h3>
                        <p><strong>Department:</strong> Filipino Dept</p>
                        <p><strong>Advisory Class:</strong> John</p>
                        <p><strong>Grade:</strong> 7</p>

                        <div className="facultyEditData">
                            <div>
                                <p><strong>Degree:</strong> BSED</p>
                                <p><strong>Major:</strong> English</p>
                        ...
                        <p><strong>Teaching load per week:</strong> 5+1 / 1140 mins (weekly)</p>
                        <p><strong>Position:</strong> T-I</p>
                        ...
                        <div className='buttonContainer'>
                            <button className="update-btn" onClick={() => setShowSuccessNotif(true)}>Update</button>
                        </div>
                    </div>
                </div>
            </ReusableModalBox>
            <ReusableModalBox show={showSuccessNotif} onClose={() => setShowSuccessNotif(false)}>
                <div className='notif'>
