...
export const Admin_Grades = () => {
    ...
    return (
        <>
            ...
            <div className='gradingContainer'>
                ...
                <div className='gradingTableContainer'>
                    <div className="gradingTableHeader">
                        ...
                        <button className="massLockBtn" onClick={() => setShowMassLock(true)}>Unlock Grade Encoding</button>
                    </div>
                    {showMassLock && (
                        <div className="massLockOverlay">
                            <div className="massLockModal">
                                ...
                                <div className="massLockOptions">
                                    <label><input type="checkbox" name="grade" /> Grade 7</label>
                                    <label><input type="checkbox" name="grade" /> Grade 8</label>
                                    <label><input type="checkbox" name="grade" /> Grade 9</label>
                                    <label><input type="checkbox" name="grade" /> Grade 10</label>
                                </div>

                                <div className="massLockActions">
                                    <button className="cancelBtn" onClick={() => setShowMassLock(false)}>Cancel</button>
                                    <button className="lockBtn" onClick={() => setShowUnlockConfirm(true)}>Unlock</button>
                                </div>
                            </div>
                        </div>
                    )}
                    <table>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>English</td>
                                <td>1st</td>
                                <td><div className="status submitted">Submitted to adviser</div></td>
                                <td><div className="encoding unlocked">Unlocked</div></td>
                                <td><button onClick={() => setShowManageEncoding(true)}>Manage Encoding</button></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>English</td>
                                <td>1st</td>
                                <td><div className="status approved">Approved by adviser</div></td>
                                <td><div className="encoding locked">Locked</div></td>
                                <td><button onClick={() => setShowManageEncoding(true)}>Manage Encoding</button></td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <div className="manageEncodingOverlay">
                            <div className='manageEncodingModal'>
                                <div className='backButton'>
                                    <i class="fa fa-times" aria-hidden="true" onClick={() => setShowManageEncoding(false)}></i>
                                </div>
                                ...
                                <div className='teacherInfoContainer'>
                                    ...
                                    <div className="statusTagsCard">
                                        <div className='status submitted'><p>Submitted to Adviser</p></div>
                                        <div className='status approved'><p>Submitted to Adviser</p></div>
                                        <div className='encoding unlocked'><p>Locked</p></div>
                                        <div className='encoding locked'><p>Locked</p></div>
                                    </div>
                                </div>
                                <div className="encodingAccessBox">
                                    <h3>Encoding Access</h3>
                                    <div className="encodingActionBtns">
                                        <button className="unlockBtn" style={{ color: "#28a745", border: "1px solid #28a745", backgroundColor: "#f6fff6" }}><i className="fa fa-unlock"></i> Unlock</button>
                                        <button className="lockBtn" style={{ color: "#d9534f", border: "1px solid #d9534f", backgroundColor: "#fff5f5" }}><i className="fa fa-lock"></i> Lock</button>
                                    </div>
                                ...
                                <div className="manageEncodingButtonContainer">
                                    <button onClick={() => setShowManageEncoding(false)}>Cancel</button>
                                    <button onClick={()=> setShowApplyChanges(true)}>Apply</button>
                                </div>
                            </div>
                        </div>
                    )}
                    <ReusableModalBox show={applyChanges} onClose={()=>setShowApplyChanges(false)}>
                        <div className='applyConfirmation'>
                            <div className='applyConfirmationTitle'>
                                <h2>Apply Changes</h2>
                            </div>
                            <div className='buttonContainer'>
                                <button onClick={() => setShowApplyChanges(false)} style={{ border: "1px solid black", backgroundColor: "transparent", color: "black" }}>Cancel</button>
                                <button onClick={() => setShowApplyNotif(true)}>Apply</button>
                            </div>
                        </div>
                    </ReusableModalBox>
                    <ReusableModalBox show={applyNotif} onClose={() => setShowApplyNotif(false)}>
                        <div className='notif'>
            ...
            <ReusableModalBox show={showUnlockConfirm} onClose={() => setShowUnlockConfirm(false)}>
                <div className='unlockConfirmation'>
                    <div className='unlockConfirmationTitle'>
                        ...
                        <p>Teachers will be able to encode grades before the encoding duration ends.</p>
                    </div>
                    <div className='buttonContainer'>
                        <button onClick={() => setShowUnlockConfirm(false)} style={{ border: "1px solid black", backgroundColor: "transparent", color: "black" }}>Cancel</button>
                        <button onClick={() => setShowUnlockNotif(true)}>Confirm</button>
                    </div>
                </div>
            </ReusableModalBox>
            <ReusableModalBox show={showUnlockNotif} onClose={() => setShowUnlockNotif(false)}>
                <div className='notif'>
                    <div className='img' style={{ paddingTop: "10px" }}>
                        <img src="checkImg.png" alt="Bagong Pilipinas Logo" style={{ height: "50px", width: "50px" }} />
                    </div>
                    <div className='notifMessage'>
