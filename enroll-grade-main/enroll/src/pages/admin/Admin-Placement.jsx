        ...
        <>
            ...
            <div className='placement-container'>
                {activeSection === "sectionList" && (
                    <>
                        <ReusableConfirmationModalBox showConfirm={showConfirm} onCloseConfirm={() => setShowConfirm(false)}>
                            <div>
                        ...
                        <ReusableModalBox show={showAddNotif} onClose={() => setShowAddNotif(false)}>
                            <div className='notif'>
                        ...
                        <div className='sectionList'>
                            ...
                            <div className='sectionListSorter'>
                                <div className='sectionListSearch'>
                                    ...
                                    <input className="sectionListSearchbar" placeholder="Search..." />
                                </div>
                                <div className='sectionListSort Grade'>
                                    <label>Section</label>
                                    <select value={sectionListGrade} onChange={(e) => setSectionListGrade(e.target.value)}>
                        ...
                        <div className='studentList'>
                            ...
                            <div className='studentListSorter'>
                                <div className='studentListSearch'>
                                    <i className="fa fa-search" aria-hidden="true"></i>
                                    <input className="studentListSearchbar" placeholder="Search..." />
                                </div>
                                <div className='studentListSort Grade'>
                                    <label>Section</label>
                                    <select value={studentListGrade} onChange={(e) => setStudentListGrade(e.target.value)}>
                                        <option value="">All Grade</option>
                                        <option>Grade 7</option>
                                        <option>Grade 8</option>
                                        <option>Grade 9</option>
